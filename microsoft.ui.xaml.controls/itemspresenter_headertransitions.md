---
-api-id: P:Microsoft.UI.Xaml.Controls.ItemsPresenter.HeaderTransitions
...
## -description
Gets or sets the collection of [Transition](../microsoft.ui.xaml.media.animation/transition.md) style elements that apply to the header of an [ItemsPresenter](itemspresenter.md).
...
## -property-value
The collection of [Transition](../microsoft.ui.xaml.media.animation/transition.md) style elements that apply to the header of an [ItemsPresenter](itemspresenter.md).
