---
-api-id: P:Microsoft.UI.Xaml.Controls.ContentPresenter.BorderBrush
...
## -property-value
The brush that is used to fill the content presenter's border. The default is **null**, (a null brush) which is evaluated as [Transparent](../microsoft.ui/colors_transparent.md) for rendering.
