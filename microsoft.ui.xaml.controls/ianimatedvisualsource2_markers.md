...
The following example shows the marker format in a Lottie JSON file. For more information, see the [Animated icon](/windows/apps/design/controls/animated-icon) guidance.
