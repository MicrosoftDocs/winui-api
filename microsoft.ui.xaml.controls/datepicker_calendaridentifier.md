...
## -remarks
Set the CalendarIdentifier property to specify the calendar system used by the [DatePicker](datepicker.md). The [DatePicker](datepicker.md) supports all calendar systems in the [CalendarIdentifiers](/uwp/api/windows.globalization.calendaridentifiers) class. To set the CalendarIdentifier in XAML, use the identifier string. To set it in code, use the corresponding [CalendarIdentifiers](/uwp/api/windows.globalization.calendaridentifiers) property. See the Examples section.
...
<table>
   ...
   <tr><td>[Gregorian](/uwp/api/windows.globalization.calendaridentifiers.gregorian)</td><td>"GregorianCalendar"</td><td>Yes.</td></tr>
   <tr><td>[Hebrew](/uwp/api/windows.globalization.calendaridentifiers.hebrew)</td><td>"HebrewCalendar"</td><td>No. Strings always in Hebrew.</td></tr>
   <tr><td>[Hijri](/uwp/api/windows.globalization.calendaridentifiers.hijri)</td><td>"HijriCalendar"</td><td>No. Strings always in Arabic.</td></tr>
   <tr><td>[Japanese](/uwp/api/windows.globalization.calendaridentifiers.japanese)</td><td>"JapaneseCalendar"</td><td>No. Strings always in Japanese.</td></tr>
   <tr><td>[Julian](/uwp/api/windows.globalization.calendaridentifiers.julian)</td><td>"JulianCalendar"</td><td>Yes.</td></tr>
   <tr><td>[Korean](/uwp/api/windows.globalization.calendaridentifiers.korean)</td><td>"KoreanCalendar"</td><td>Yes.</td></tr>
   <tr><td>[Taiwan](/uwp/api/windows.globalization.calendaridentifiers.taiwan)</td><td>"TaiwanCalendar"</td><td>Yes.</td></tr>
   <tr><td>[Thai](/uwp/api/windows.globalization.calendaridentifiers.thai)</td><td>"ThaiCalendar"</td><td>Yes.</td></tr>
   <tr><td>[UmAlQura](/uwp/api/windows.globalization.calendaridentifiers.umalqura)</td><td>"UmAlQuraCalendar"</td><td>No. Strings always in Arabic.</td></tr>
</table>
...
To set the CalendarIdentifier on code, use the value returned by the corresponding [CalendarIdentifiers](/uwp/api/windows.globalization.calendaridentifiers) property, as shown here.
...
## -see-also
[CalendarIdentifiers](/uwp/api/windows.globalization.calendaridentifiers), [DateTimeFormatter.Calendar](/uwp/api/windows.globalization.datetimeformatting.datetimeformatter.calendar), [Quickstart: Adding a DatePicker](/previous-versions/windows/apps/dn308514(v=win.10))
