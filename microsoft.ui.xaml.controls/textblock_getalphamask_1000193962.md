---
-api-id: M:Microsoft.UI.Xaml.Controls.TextBlock.GetAlphaMask
...
# Microsoft.UI.Xaml.Controls.TextBlock.GetAlphaMask

## -description
Returns a mask that represents the alpha channel of the text as a [CompositionBrush](../microsoft.ui.composition/compositionbrush.md).

## -returns
A mask that represents the alpha channel of the text in a [TextBlock](textblock.md).

## -remarks
This method gets an alpha mask from the text as a [CompositionBrush](../microsoft.ui.composition/compositionbrush.md) that you can use as an input to composition shadows and effects. The alpha mask [CompositionBrush](../microsoft.ui.composition/compositionbrush.md) has the same alignment and stretch property values that the source XAML element applies to its rendered content so that you can use those values to correctly position shadows or effects relative to the XAML element.
