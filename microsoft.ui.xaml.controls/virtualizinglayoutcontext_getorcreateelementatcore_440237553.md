...
When implemented in a derived class, retrieves a [UIElement](/uwp/api/windows.ui.xaml.uielement) that represents the data item in the source found at the specified index using the specified options.
...
The index of the data item to retrieve a [UIElement](/uwp/api/windows.ui.xaml.uielement) for.
...
A [UIElement](/uwp/api/windows.ui.xaml.uielement) that represents the data item.
