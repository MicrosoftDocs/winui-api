...
You can use a [DateTimeFormatter](/uwp/api/windows.globalization.datetimeformatting.datetimeformatter) object to format the contents of each [ComboBox](combobox.md) selector. For more info, see [Date picker](/windows/uwp/controls-and-patterns/date-picker).
