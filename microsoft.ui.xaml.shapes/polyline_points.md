---
-api-id: P:Microsoft.UI.Xaml.Shapes.Polyline.Points
...
## -property-value
A collection of [Point](/uwp/api/windows.foundation.point) structures that describes the vertex points of the [Polyline](polyline.md). The default is null.
