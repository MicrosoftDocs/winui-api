---
-api-id: M:Microsoft.UI.Text.ITextRange.Move(Microsoft.UI.Text.TextRangeUnit,System.Int32)
...
# Microsoft.UI.Text.ITextRange.Move
...
See also the [ITextRange.MoveStart](itextrange_movestart_1643446878.md) and [ITextRange.MoveEnd](itextrange_moveend_710856136.md) methods, which move the range start or end position *count*  *unit* s, respectively.

## -examples

## -see-also
[ITextRange.MoveEnd](itextrange_moveend_710856136.md), [ITextRange.MoveStart](itextrange_movestart_1643446878.md)
