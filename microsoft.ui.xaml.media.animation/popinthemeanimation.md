---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.PopInThemeAnimation
...
## -examples
The following shows an example template for a [ToolTip](../microsoft.ui.xaml.controls/tooltip.md) control that uses PopInThemeAnimation and [PopOutThemeAnimation](popoutthemeanimation.md).
