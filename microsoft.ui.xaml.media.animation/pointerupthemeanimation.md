---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.PointerUpThemeAnimation
...
PointerUpThemeAnimation overrides the current values of [Projection](../microsoft.ui.xaml/uielement_projection.md) and [RenderTransform](../microsoft.ui.xaml/uielement_rendertransform.md) and sets them to their default values.

> **Windows 8.1 and prior**
> [Projection](../microsoft.ui.xaml/uielement_projection.md) and [RenderTransform](../microsoft.ui.xaml/uielement_rendertransform.md) are not affected by [PointerDownThemeAnimation](pointerdownthemeanimation.md).
