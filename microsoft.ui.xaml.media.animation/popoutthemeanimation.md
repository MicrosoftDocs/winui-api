---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.PopOutThemeAnimation
...
## -examples
The following shows an example template for a [ToolTip](../microsoft.ui.xaml.controls/tooltip.md) control that uses [PopInThemeAnimation](popinthemeanimation.md) and PopOutThemeAnimation.
