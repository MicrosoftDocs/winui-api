---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.EntranceThemeTransition
...
## -examples
This example shows a how to apply an EntranceThemeTransition to a [Button](../microsoft.ui.xaml.controls/button.md).
