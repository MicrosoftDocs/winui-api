...
+ Members that come from the system input conceptualization of a [ExpPointerPoint](../microsoft.ui.input.experimental/exppointerpoint.md). Use the [GetCurrentPoint](pointerroutedeventargs_getcurrentpoint_293890010.md) API to get a [ExpPointerPoint](../microsoft.ui.input.experimental/exppointerpoint.md) value, then call [ExpPointerPoint](../microsoft.ui.input.experimental/exppointerpoint.md) API such as [Microsoft.UI.Input.Experimental.ExpPointerPoint.Position](../microsoft.ui.input.experimental/exppointerpoint_position.md) and [ExpPointerPointProperties](../microsoft.ui.input.experimental/exppointerpointproperties.md).

Specific events often have information available in the various pointer device and pointer point classes that is mainly only relevant for that event. For example, when you handle [PointerWheelChanged](../microsoft.ui.xaml/uielement_pointerwheelchanged.md), you might be interested in the [MouseWheelDelta](../microsoft.ui.input.experimental/exppointerpointproperties_mousewheeldelta.md) from [ExpPointerPointProperties](../microsoft.ui.input.experimental/exppointerpointproperties.md).

The object retrieved by the GetCurrentPoint and GetIntermediatePoints methods provide access to extended pointer info through the [Properties](../microsoft.ui.input.experimental/exppointerpoint_properties.md) property, which gets a [ExpPointerPointProperties](../microsoft.ui.input.experimental/exppointerpointproperties.md) object.

In the following example, we get extended pointer properties through the [ExpPointerPoint](../microsoft.ui.input.experimental/exppointerpoint.md) and [ExpPointerPointProperties](../microsoft.ui.input.experimental/exppointerpointproperties.md) objects. (See [Quickstart: Pointers](/previous-versions/windows/apps/hh465383(v=win.10)) for the complete example.)

[!code-csharp[SnippetQueryPointer](../microsoft.ui.input.inking/code/PointerInput/csharp/MainPage.xaml.cs#SnippetQueryPointer)]

Typically, the object returned by this method is used to feed pointer data to a [ExpGestureRecognizer](../microsoft.ui.input.experimental/expgesturerecognizer.md). Another scenario is getting the [MouseWheelDelta](../microsoft.ui.input.experimental/exppointerpointproperties_mousewheeldelta.md) for a [PointerWheelChanged](../microsoft.ui.xaml/uielement_pointerwheelchanged.md) event; that value is in [ExpPointerPointProperties](../microsoft.ui.input.experimental/exppointerpointproperties.md).
