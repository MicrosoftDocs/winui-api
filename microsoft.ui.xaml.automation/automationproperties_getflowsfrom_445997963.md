---
-api-id: M:Microsoft.UI.Xaml.Automation.AutomationProperties.GetFlowsFrom(Microsoft.UI.Xaml.DependencyObject)
...
# Microsoft.UI.Xaml.Automation.AutomationProperties.GetFlowsFrom
...
## -remarks
Get the list, then call the [Add](/dotnet/api/system.collections.generic.icollection-1.add?view=dotnet-uwp-10.0&preserve-view=true#System_Collections_Generic_ICollection_1_Add__0_) method to add a new element.
