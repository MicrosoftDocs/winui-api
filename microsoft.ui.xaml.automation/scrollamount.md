---
-api-id: T:Microsoft.UI.Xaml.Automation.ScrollAmount
-api-type: winrt enum
---
...
## -description
Contains values that are used by the [IScrollProvider](../microsoft.ui.xaml.automation.provider/iscrollprovider.md) pattern to indicate the direction and distance to scroll.
