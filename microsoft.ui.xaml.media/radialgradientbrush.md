...
If you have the **XAML Controls Gallery** app installed, [open the app to see the RadialGradientBrush in action](xamlcontrolsgallery:/item/RadialGradientBrush).
