...
## -see-also
[RightTapped](uielement_righttapped.md), [OnRightTapped](/uwp/api/windows.ui.xaml.controls.control.onrighttapped(windows.ui.xaml.input.righttappedroutedeventargs)), [Handle pointer input](/windows/uwp/design/input/handle-pointer-input)
