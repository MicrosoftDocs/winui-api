...
+ For layout containers, the coordinate frame of reference changes. "(0, 0)" in a [Canvas](../microsoft.ui.xaml.controls/canvas.md) is the top right corner. The "0" column in a Grid for purposes of [Grid.Column](/uwp/api/microsoft.ui.xaml.controls.grid#xaml-attached-properties) is the rightmost column.
