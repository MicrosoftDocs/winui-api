...
Describes a font variant value for the [Typography.Variants](/uwp/api/microsoft.ui.xaml.documents.typography#xaml-attached-properties) attached property.
...
This enumeration is used by the [Typography.Variants](/uwp/api/microsoft.ui.xaml.documents.typography#xaml-attached-properties) attached property.

Some fonts might support a subset of variant values, or ignore the setting completely.

Some fonts might also algorithmically approximate a font form instead of supporting [Typography.Variants](/uwp/api/microsoft.ui.xaml.documents.typography#xaml-attached-properties). 
