...
For custom controls and interaction experiences, see [ExpGestureRecognizer.ManipulationInertiaStarting](../microsoft.ui.input/gesturerecognizer_manipulationinertiastarting.md).
