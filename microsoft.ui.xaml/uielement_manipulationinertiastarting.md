...
For custom controls and interaction experiences, see [ExpGestureRecognizer.ManipulationInertiaStarting](../microsoft.ui.input.experimental/expgesturerecognizer_manipulationinertiastarting.md).
