...
For custom controls and interaction experiences, see [ExpGestureRecognizer.ManipulationStarted](../microsoft.ui.input/gesturerecognizer_manipulationstarted.md).
