...
## -see-also
[Tapped](uielement_tapped.md), [OnTapped](/uwp/api/windows.ui.xaml.controls.control.ontapped(windows.ui.xaml.input.tappedroutedeventargs)), [Handle pointer input](/windows/uwp/design/input/handle-pointer-input)
