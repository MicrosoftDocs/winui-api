...
For custom controls and interaction experiences, see [GestureRecognizer.ManipulationCompleted](/uwp/api/windows.ui.input.gesturerecognizer.manipulationcompleted).
