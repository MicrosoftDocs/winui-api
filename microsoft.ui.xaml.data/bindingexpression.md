...
You can obtain a BindingExpression object by calling the [GetBindingExpression](/uwp/api/windows.ui.xaml.frameworkelement.getbindingexpression(windows.ui.xaml.dependencyproperty)) method on an object, specifying the dependency property that has the binding.
