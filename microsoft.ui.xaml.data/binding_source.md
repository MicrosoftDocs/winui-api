---
-api-id: P:Microsoft.UI.Xaml.Data.Binding.Source
...
To create a data source that is inherited by all the child elements in the tree, instead set the [DataContext](../microsoft.ui.xaml/frameworkelement_datacontext.md) property on the parent element. Then the parent element and all its children look to the [DataContext](../microsoft.ui.xaml/frameworkelement_datacontext.md) as the source of their bindings. If the Source is set for a child element, it will override the [DataContext](../microsoft.ui.xaml/frameworkelement_datacontext.md) inheritance in that instance.
