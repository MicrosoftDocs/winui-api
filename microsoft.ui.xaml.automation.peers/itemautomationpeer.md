---
-api-id: T:Microsoft.UI.Xaml.Automation.Peers.ItemAutomationPeer
...
## -description
Exposes a data item in an [Items](../microsoft.ui.xaml.controls/itemscontrol_items.md) collection to Microsoft UI Automation.
...
+ [GetPattern](automationpeer_getpattern_1700082720.md) reports that the peer supports [PatternInterface.VirtualizedItem](patterninterface.md) ([IVirtualizedItemProvider](../microsoft.ui.xaml.automation.provider/ivirtualizeditemprovider.md)). Also, there is "GetContainerPeer" logic that reports information about the item container's supported patterns.
