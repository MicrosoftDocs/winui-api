---
-api-id: T:Microsoft.UI.Composition.CompositionEffectSourceParameter
...
# Microsoft.UI.Composition.CompositionEffectSourceParameter

## -description
Used to declare an arbitrary name (a String) to be associated with a CompositionBrush (the “effect source”). The association of the given name and the effect source occurs when the [SetSourceParameter](compositioneffectbrush_setsourceparameter_286598971.md) method of a [CompositionEffectBrush](compositioneffectbrush.md) is called.
